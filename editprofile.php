...
?>
 ...
 <td width="182"><input type="text" name="fname" value="<?php echo $row['fname']?>" id="fname">
</td>
 </tr>
 <tr>
...
<tr>
<td>Occupation</td>
<td><input type="text" name="occp" value="<?php echo $row['occp']?>" id="occp">
      </td>
</tr>
...
<tr>
<td>phone no</td>
<td><input type="text" name="phno" value="<?php echo $row['phno']?>" id="phno">
      </td>
</tr>
 
 
        <tr>
        	<td><input type="submit" name="upd" value="Save Changes" id="ok"></td>	
        </tr>
    </table>
</form>
<?php
