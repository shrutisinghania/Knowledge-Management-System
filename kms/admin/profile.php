...
<html>
	<head>
		...
		<link rel="stylesheet" href="../images/assets/css/main.css" />
	</head>
	<body class="subpage">

		<!-- Header -->
			<header id="header">
				<div class="logo"><a href="../images/index.html">Urban <span>by TEMPLATED</span></a></div>
				<a href="#menu">Menu</a>
			</header>
							...
							<div class="flex flex-2">
								...
								<div class="col col1 first">
									<div class="image round fit">
										<a href="../images/generic.html" class="link"><img src="../images/images/pic02.jpg" alt="" /></a>
									</div>
								</div>
							</div>
						...
						<div class="inner">
							...
							<div class="flex flex-3">
								<div class="col align-center">
									<div class="image round fit">
										<img src="../images/images/pic03.jpg" alt="" />
									</div>
								...
								<div class="col align-center">
									<div class="image round fit">
										<img src="../images/images/pic05.jpg" alt="" />
									</div>
									<p>Sed congue elit malesuada nibh, a varius odio vehicula aliquet. Aliquam consequat, nunc quis sollicitudin aliquet. </p>
									<a href="#" class="button">Learn More</a>
								</div>
								<div class="col align-center">
									<div class="image round fit">
										<img src="../images/images/pic04.jpg" alt="" />
									</div>
									<p>Sed congue elit malesuada nibh, a varius odio vehicula aliquet. Aliquam consequat, nunc quis sollicitudin aliquet. </p>
									<a href="#" class="button">Learn More</a>
								</div>
		...
		<!-- Scripts -->
			...
			<script src="../images/assets/js/jquery.scrolly.min.js"></script>
			<script src="../images/assets/js/jquery.scrollex.min.js"></script>
			<script src="../images/assets/js/skel.min.js"></script>
			<script src="../images/assets/js/util.js"></script>
